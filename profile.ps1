...
If (Test-Path "$env:LOCALAPPDATA\anaconda3\Scripts\conda.exe") {
    (& "$env:LOCALAPPDATA\anaconda3\Scripts\conda.exe" "shell.powershell" "hook") | Out-String | ?{$_} | Invoke-Expression
}
